...
@section('title', 'تعديل تقييم المشرف')
...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="mb-6">
                    <h1 class="text-2xl font-bold mb-2">تعديل تقييم المشرف</h1>
                ...
                <form action="{{ route('supervisor-evaluations.update', $supervisorEvaluation) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                                ...
                                <input type="number" name="work_quality" id="work_quality" min="1" max="10" step="0.1"
                                       ...
                                       value="{{ old('work_quality', $supervisorEvaluation->work_quality) }}" required>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                                ...
                                <input type="number" name="punctuality" id="punctuality" min="1" max="10" step="0.1"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                                       value="{{ old('punctuality', $supervisorEvaluation->punctuality) }}" required>
                                <div class="mt-1 text-xs text-gray-500">من 1 إلى 10</div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                                ...
                                <input type="number" name="teamwork" id="teamwork" min="1" max="10" step="0.1"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                                       value="{{ old('teamwork', $supervisorEvaluation->teamwork) }}" required>
                                <div class="mt-1 text-xs text-gray-500">من 1 إلى 10</div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                                ...
                                <input type="number" name="innovation" id="innovation" min="1" max="10" step="0.1"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                                       value="{{ old('innovation', $supervisorEvaluation->innovation) }}" required>
                                <div class="mt-1 text-xs text-gray-500">من 1 إلى 10</div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                                ...
                                <input type="number" name="technical_skills" id="technical_skills" min="1" max="10" step="0.1"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                                       value="{{ old('technical_skills', $supervisorEvaluation->technical_skills) }}" required>
                                <div class="mt-1 text-xs text-gray-500">من 1 إلى 10</div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                                ...
                                <input type="number" name="communication" id="communication" min="1" max="10" step="0.1"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                                       value="{{ old('communication', $supervisorEvaluation->communication) }}" required>
                                <div class="mt-1 text-xs text-gray-500">من 1 إلى 10</div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                                ...
                                <input type="number" name="progress_score" id="progress_score" min="0" max="100" step="0.1"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                                       value="{{ old('progress_score', $supervisorEvaluation->progress_score) }}">
                        ...
                        <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                            ...
                            <input type="number" name="overall_assessment" id="overall_assessment" min="1" max="10" step="0.1"
                                   ...
                                   value="{{ old('overall_assessment', $supervisorEvaluation->overall_assessment) }}" required>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea name="strengths" id="strengths" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                                          placeholder="اذكر نقاط القوة في المشروع...">{{ old('strengths', $supervisorEvaluation->strengths) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="weaknesses" id="weaknesses" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                                          placeholder="اذكر نقاط الضعف التي تحتاج تحسين...">{{ old('weaknesses', $supervisorEvaluation->weaknesses) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="recommendations" id="recommendations" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                                          placeholder="اذكر توصياتك للتحسين...">{{ old('recommendations', $supervisorEvaluation->recommendations) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="general_comments" id="general_comments" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                                          placeholder="أي ملاحظات إضافية...">{{ old('general_comments', $supervisorEvaluation->general_comments) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end space-x-3 space-x-reverse pt-4 border-t border-gray-200 dark:border-gray-700">
                        <a href="{{ route('supervisor-evaluations.show', $supervisorEvaluation) }}" 
                        ...
                        @if($supervisorEvaluation->status !== 'finalized')
                        ...
                        @else
                            <span class="px-6 py-2 bg-gray-300 dark:bg-gray-600 text-gray-600 dark:text-gray-400 rounded-md cursor-not-allowed">
                                التقييم مقرر نهائياً ولا يمكن تعديله
                            </span>
                        @endif
                    </div>
                </form>
